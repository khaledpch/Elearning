...
<section class="tz-wrapper-default">
		...
		$result = mysql_query("SELECT `id_tuteur`,`pseudo`, `pass`,CONCAT(`Nom`,' ', `prenom`) as np, `ville`,`photo`, `email`,`tel` ,`specialite`,`date_naiss`, `grade` FROM `tuteurs` WHERE `pseudo`='$pseudo_tut'");
	   ...
	   $user_prenom = mysql_result($result,$i,"np");
	    $user_ville = mysql_result($result,$i,"ville");
		 ...
		 $user_nivo= mysql_result($result,$i,"grade");
		  $user_spec= mysql_result($result,$i,"specialite");
		 }
                ...
                <div class="tz-link-widget">
                    ...
                    <aside class="widget widget-link">
                        <ul>
                            ...
                            <li>
                                <a href="modif_pass.php?id_tut=<?php echo  $user_id ?>">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="tz-joom-profile">
				   ...
				   <p> email :<?php echo $user_email ?> </p>
                    ...
                    <p> specialite : <?php echo  $user_spec?> </p>
					<p> Ville : <?php echo $user_ville ?> </p>
					<p> Date de naissance : <?php echo $user_date ?> </p>
					
                    <div class="tz-profile-courses">
                        <h5 class="tz-profile-title"><img src="demos/check.png" alt="Image"><a href="#">Mes COURS</a></h5>
	   ...
	   $cour_fich= mysql_result($result,$i,"fichier");
	    $cour_photo = mysql_result($result,$i,"photo");
		 $cour_descrip= mysql_result($result,$i,"description");
                        ...
                        ?>
						<a href="Courses-Single.php?id_cour=<?php echo $cour_id ?>"><p ><?php echo $cour_tit?></p></a>
						<?php
}
mysql_close();
?>
