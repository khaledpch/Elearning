                    ...
                    <ul class="tz-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu sub-menu-style-1">
                                <li>
                                    <a href="ajout_sujet.php">Ajouter sujet</a>
                                </li>
                                <li>
	   ...
	   mysql_free_result ($req2);
                        ...
                        <ul class="tz-blog-more">
                            <li>
                                ...
                                <span>
                                    <a class="delete"  href="delete_sujet.php?id_sujet=<?php echo $sujet_id ?>"><i ></i>Supprimer</a>
                                </span>
                            </li>
                        </ul>
                    </div>
...
$('.delete').click(function(){
   ...
   var response = confirm("Voulez-vous vraiment supprimer ce sujet ?");
