                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
						  	  	<?php
								if(isset($_GET['id_app'])or isset($_GET['modif'])) {
 include("conx.php");


$idd=$_GET['id_app'];

$result=mysql_query("SELECT * FROM ` apprenants` WHERE `id_apprenant`= '$idd'");//delete query
$nblignes = mysql_numrows($result);
...
for ($i=0;$i<$nblignes;$i=$i+1) {
	 ...
	 $user_pseudop = mysql_result($result,$i,"pseudo");
	  $user_passp = mysql_result($result,$i,"password");
	   ...
	   $user_prenomp = mysql_result($result,$i,"prenom");
	    ...
	    $user_villep = mysql_result($result,$i,"ville");
		 ...
		 $user_nivop= mysql_result($result,$i,"niveau_app");
		...
		$sql = ("UPDATE ` apprenants` SET `pseudo`='$user_pseudop',`password`='$user_passp',`Nom`='$user_nomp',`prenom`='$user_prenomp',`ville`='$user_villep',`email`='$user_emailp',`date_naiss`='$user_datep',`tel`='$user_telp',`niveau_app`='$user_nivop',`sexe`='$user_sexep'  WHERE `id_apprenant`='$id' ");
