                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal " id="register_form" method="post" action="ajout.php">
                                      ...
                                      <div class="form-group ">
									     ...
									     <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control " id="username" name="nivo_app" type="text" />
                                          </div> 
										  </div>
                                      <div class="form-group ">
...
if(isset($_POST['register']))
{
	...
	$user_nivo=$_POST['nivo_app'];
	 $user_sexe=$_POST['sexe_app'];//same
	  $user_photos=$_POST['photos_app'];
	 

    if(empty($user_login)||empty($user_pass)||empty($user_name)||empty($user_prenom)||empty($user_ville)||empty($user_email)||empty($user_date)||empty($user_tel)||empty($user_nivo)||empty($user_sexe))
    {
...
//insert the user into the database.
    ...
    $sql="INSERT INTO ` apprenants` (`id_apprenant`, `pseudo`, `password`, `Nom`, `prenom`, `ville`, `email`,`date_naiss`, `tel`, `niveau_app`, `sexe`, `photo`) VALUE ('','$user_login','$user_pass','$user_name','$user_prenom','$user_ville','$user_email','$user_date','$user_tel','$user_nivo','$user_sexe','$user_photos')";
	$res=mysql_query($sql);
   if ($res) {
    echo "<script>alert('apprenant est ajouté avec succèe')</script>";
