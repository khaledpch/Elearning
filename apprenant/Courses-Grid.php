...
<body>
	...
	<?php
	include("../admin/conx.php");
	$result = mysql_query("SELECT `id_cour` ,` titel`, `nivo_etud`, `fichier`, `photo`, `description` FROM `cours`");
                        ...
                        <div class=\"element\">
                            <div class=\"tz-portfolio-wapper-style-3\">
                                <div class=\"tz-image-item tz-portfolio-images\">
                                    <img src=\"../../isims/tuteur/img/$cour_photo\" />
                                </div>
                                <div class=\"tz-portfolio-content-style-3\">
                                    ...
                                    <small>
                                        <a href=\"#\"> $cour_niv </a>
                                        <a href=\"../../isims/tuteur/crs/$cour_fich\" download=\"$cour_fich\" >Telecharger</a>
                                    </small>
                            <span>";?>
