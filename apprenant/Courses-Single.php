...
<?php echo $cour_tit ?>                                   </h3>
                                    <form class="tz-form-ticket tz-form-courses" name="frm_ticket" method="post" action="#">
                                        ...
                                        <button type="submit">
                                            <i class="fa fa-arrows-alt"></i><a href="index.php">
participer au quiz
                                        <a/></button>
                                    </form>
                                </div>
...
?>
                                <a href="#"><img src="<?php echo$dat2['photo'];?><?php echo$dat['photo'];?>" alt="NATASHA" height="35x" width="35"></a>
                            </div>
	   ...
	   mysql_free_result ($req);
								...
								?>
                                      <a href="#">  <strong><?php echo $dat2['np']; ?><?php echo $dat['np']; ?></strong></a>
                    ...
                    <form method="post" id="form" action="?id_cour=<?php echo $id?>">
                       <input type="hidden" name="id_cour" value="<?php echo $id;?>">
					    ...
					    <input type="hidden" name="sujet_app" value="<?php echo $data['id_apprenant'];?>">
						 <input type="hidden" name="sujet_tut" value="<?php echo $data2['id_tuteur'];?>">
