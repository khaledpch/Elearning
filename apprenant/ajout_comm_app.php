			...
			?>
                    ...
                    <div class="tz-single-share">
                        ...
                        <ul class="pull-right">
                            <li>
                                <small>
                                    <a class="tz-button-more" href="ajout_sujet_app.php">Ajouter un sujet</a>
                                </small>
...
$sql=("SELECT `id_apprenant` FROM ` apprenants` WHERE `pseudo`='$pseudo_tut'");
	   $req=mysql_query($sql)or die('Erreur SQL !<br />'.$sql.'<br />'.mysql_error());
...
exit();
	 ...
	 $sql="INSERT INTO `commentraires`(`id_comm`, `contenu_comm`, `id_sujet`, `id_admin`, `id_tuteur`, `id_apprenant`) VALUES ('','$comm_tit','$comm_sujet','$comm_admin','$comm_tut',' $comm_app')";
	//var_dump($sql);
	//exit();
	$res=mysql_query($sql);
...
?>
                    ...
                    <form method="post" id="form" action="?id_sujet=<?php echo $id?>">
                       <input type="hidden" name="id_sujet" value="<?php echo $id;?>">
					    <input type="hidden" name="sujet_app" value="<?php echo $data['id_apprenant'];?>">
					   <input type="hidden" name="sujet_admin" value="<?php echo $data2['id_admin'];?>">
					    <input type="hidden" name="sujet_tut" value="<?php echo $data1['id_tuteur'];?>">
