...
exit();
	 ...
	 $sql="INSERT INTO `sujets`(`id_sujet`, `titre`, `date_ajout`, `contenu`, `id_admin`, `id_tuteur`, `id_apprenant`) VALUES ('','$sujet_tit','$date ','$sujet_descrip','$sujet_tut','$sujet_admin','$sujet_app')";
	//var_dump($sql);
	//exit();
	$res=mysql_query($sql);
   if ($res) {
...
?>
	...
	<form class="form-register" method="post" action="ajout_sujet_app.php">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                <input type="text" placeholder="Titre du cours (max. 20 caractères) " name="titre" id="titre" Maxlength="100" required>
                                            </div>
                                        </div>
										 ...
										 <div class="row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                               ...
                                               <TEXTAREA name="descrip" id "descrip" rows=10 cols=100 required></TEXTAREA>
